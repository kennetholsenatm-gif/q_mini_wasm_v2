...
def get_curriculum_phases() -> List[dict[str, Any]]:
    ...
    return [
        {"name": "latent_isa", "description": "Freeze semantic experts; train 2D heads and ternary WASM experts."},
        {"name": "autoregressive_trace", "description": "Open-ended trace unrolling; hull queries for state retrieval."},
