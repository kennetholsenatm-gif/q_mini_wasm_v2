...
This diagram illustrates the data flow through the Quantum Graph Neural
Network (QGNN) system, from input to output.
...
- **TritPack5**: Packs 5 trits into 8 bits for memory efficiency (60%
reduction)
